...
IsoRat<-function(gdgt,complete=TRUE,na.ignore=FALSE){
  ...
  formula<-"( gdgt$IIa6 + gdgt$IIb6 + gdgt$IIc6 + gdgt$IIIa6 + gdgt$IIIb6 + gdgt$IIIc6 )/( gdgt$IIa5 + gdgt$IIb5 + gdgt$IIc5 + gdgt$IIIa5 + gdgt$IIIb5 + gdgt$IIIc5 + gdgt$IIa6 + gdgt$IIb6 + gdgt$IIc6 + gdgt$IIIa6 + gdgt$IIIb6 + gdgt$IIIc6 )"
